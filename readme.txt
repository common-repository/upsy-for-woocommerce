...
== Screenshots ==
1. AI-driven upselling and cross-selling functions, enhancing revenue with smart product recommendations.
2. Visually engaging categories that work smoothly on mobile devices, improving navigation and product discovery.
3. Daily deals section that encourages customers with attractive offers, speeding up inventory turnover.
4. User feedback survey to gauge customer satisfaction and gather valuable insights for improvement.
5. New arrivals feature showcasing the latest additions to your store, prompting users to explore and purchase.
6. Frequently Asked Questions (FAQs) list, saving you time by answering common customer inquiries automatically.
7. Main dashboard overview, highlighting analytics and performance metrics enabled by Upsy.
...
- Removed analytics features.
- Fixed bug.

== Upgrade Notice ==
Please update your plugin vesion 3.4.0 to 3.4.1